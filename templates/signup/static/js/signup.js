...
function proceed() {
    var form_divs = document.getElementsByClassName('form__div');
    for (var i = 0; i < form_divs.length; ++i) {
        var element = form_divs[i];  
    ...
    if (page == 1) {
        ...
        document.getElementById("submit-btn").classList.remove("hidden-btn");
        document.getElementById("proceed-btn").classList.add("hidden-btn");
    } else {
        document.getElementById("back-btn").classList.add("hidden-btn");
        document.getElementById("submit-btn").classList.add("hidden-btn");
        document.getElementById("proceed-btn").classList.remove("hidden-btn");
    }
}
